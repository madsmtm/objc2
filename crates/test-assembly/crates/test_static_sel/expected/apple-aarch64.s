...
_fn1_get_sel:
Lloh0:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb@PAGE
Lloh1:
	ldr	x0, [x8, _OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb@PAGEOFF]
	ret
...
_fn2_get_same_sel:
Lloh2:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_9303807037ba4f9f@PAGE
Lloh3:
	ldr	x0, [x8, _OBJC_SELECTOR_REFERENCES_9303807037ba4f9f@PAGEOFF]
	ret
...
Lloh4:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_alloc@GOTPAGE
Lloh5:
	ldr	x8, [x8, _OBJC_SELECTOR_REFERENCES_alloc@GOTPAGEOFF]
Lloh6:
	ldr	x0, [x8]
	mov	x1, x0
	ret
...
Lloh7:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85@PAGE
Lloh8:
	ldr	x0, [x8, _OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85@PAGEOFF]
	ret
...
_fn6_use_fns:
Lloh9:
	adrp	x9, _OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb@PAGE
Lloh10:
	ldr	x9, [x9, _OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb@PAGEOFF]
Lloh11:
	adrp	x10, _OBJC_SELECTOR_REFERENCES_9303807037ba4f9f@PAGE
Lloh12:
	ldr	x10, [x10, _OBJC_SELECTOR_REFERENCES_9303807037ba4f9f@PAGEOFF]
Lloh13:
	adrp	x11, _OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85@PAGE
Lloh14:
	ldr	x11, [x11, _OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85@PAGEOFF]
Lloh15:
	adrp	x12, _OBJC_SELECTOR_REFERENCES_e91a5376ddae3cfc@PAGE
Lloh16:
	ldr	x12, [x12, _OBJC_SELECTOR_REFERENCES_e91a5376ddae3cfc@PAGEOFF]
	stp	x9, x10, [x8]
	stp	x11, x12, [x8, #16]
	ret
