...
_fn1_get_sel:
	push	{r7, lr}
	mov	r7, sp
	movw	r0, :lower16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC0_0+8))
	movt	r0, :upper16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC0_0+8))
LPC0_0:
	ldr	r0, [pc, r0]
	pop	{r7, pc}
...
_fn2_get_same_sel:
	push	{r7, lr}
	mov	r7, sp
	movw	r0, :lower16:(_OBJC_SELECTOR_REFERENCES_9303807037ba4f9f-(LPC1_0+8))
	movt	r0, :upper16:(_OBJC_SELECTOR_REFERENCES_9303807037ba4f9f-(LPC1_0+8))
LPC1_0:
	ldr	r0, [pc, r0]
	pop	{r7, pc}
...
_fn3_get_common_twice:
	push	{r7, lr}
	mov	r7, sp
	movw	r0, :lower16:(L_OBJC_SELECTOR_REFERENCES_alloc$non_lazy_ptr-(LPC2_0+8))
	movt	r0, :upper16:(L_OBJC_SELECTOR_REFERENCES_alloc$non_lazy_ptr-(LPC2_0+8))
LPC2_0:
	ldr	r0, [pc, r0]
	ldr	r0, [r0]
	mov	r1, r0
...
_fn4_get_different_sel:
	push	{r7, lr}
	mov	r7, sp
	movw	r0, :lower16:(_OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85-(LPC3_0+8))
	movt	r0, :upper16:(_OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85-(LPC3_0+8))
LPC3_0:
	ldr	r0, [pc, r0]
	pop	{r7, pc}
...
_fn6_use_fns:
	push	{r7, lr}
	mov	r7, sp
	movw	r1, :lower16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC5_0+8))
	movt	r1, :upper16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC5_0+8))
LPC5_0:
	ldr	r1, [pc, r1]
	movw	r2, :lower16:(_OBJC_SELECTOR_REFERENCES_9303807037ba4f9f-(LPC5_1+8))
	movt	r2, :upper16:(_OBJC_SELECTOR_REFERENCES_9303807037ba4f9f-(LPC5_1+8))
LPC5_1:
	ldr	r2, [pc, r2]
	movw	r3, :lower16:(_OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85-(LPC5_2+8))
	movt	r3, :upper16:(_OBJC_SELECTOR_REFERENCES_ff60dae1998e0c85-(LPC5_2+8))
LPC5_2:
	ldr	r3, [pc, r3]
	movw	r9, :lower16:(_OBJC_SELECTOR_REFERENCES_e91a5376ddae3cfc-(LPC5_3+8))
	movt	r9, :upper16:(_OBJC_SELECTOR_REFERENCES_e91a5376ddae3cfc-(LPC5_3+8))
LPC5_3:
	ldr	r9, [pc, r9]
	stm	r0, {r1, r2, r3, r9}
	pop	{r7, pc}
...
_fn7_use_same_twice:
	push	{r7, lr}
	mov	r7, sp
	movw	r1, :lower16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC6_0+8))
	movt	r1, :upper16:(_OBJC_SELECTOR_REFERENCES_2668dedcc69bf8fb-(LPC6_0+8))
LPC6_0:
	ldr	r1, [pc, r1]
	str	r1, [r0]
	str	r1, [r0, #4]
