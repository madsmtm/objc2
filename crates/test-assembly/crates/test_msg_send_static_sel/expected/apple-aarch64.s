...
Lloh0:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_66d4c61f523c7074@PAGE
Lloh1:
	ldr	x1, [x8, _OBJC_SELECTOR_REFERENCES_66d4c61f523c7074@PAGEOFF]
	b	_objc_msgSend
...
_fn3_use_generic:
	...
	mov	x19, x0
Lloh10:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_8d4579a56572fa21@PAGE
Lloh11:
	ldr	x1, [x8, _OBJC_SELECTOR_REFERENCES_8d4579a56572fa21@PAGEOFF]
	adrp	x20, _OBJC_SELECTOR_REFERENCES_e348e18690a1021e@PAGE
	ldr	x2, [x20, _OBJC_SELECTOR_REFERENCES_e348e18690a1021e@PAGEOFF]
	bl	_objc_msgSend
Lloh12:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_d018146ff130bbd9@PAGE
Lloh13:
	ldr	x1, [x8, _OBJC_SELECTOR_REFERENCES_d018146ff130bbd9@PAGEOFF]
	ldr	x2, [x20, _OBJC_SELECTOR_REFERENCES_e348e18690a1021e@PAGEOFF]
	mov	x0, x19
	bl	_objc_msgSend
Lloh14:
	adrp	x8, _OBJC_SELECTOR_REFERENCES_6659046596384437@PAGE
Lloh15:
	ldr	x1, [x8, _OBJC_SELECTOR_REFERENCES_6659046596384437@PAGEOFF]
	ldr	x2, [x20, _OBJC_SELECTOR_REFERENCES_e348e18690a1021e@PAGEOFF]
	mov	x0, x19
	ldp	x29, x30, [sp, #16]
	ldp	x20, x19, [sp], #32
