...
LPC1_0:
	...
	mov	r1, r4
	mov	lr, pc
	b	SYM(objc2[CRATE_ID]::__macros::retain_semantics::new_fail, 0)
...
LPC9_0:
	add	r0, pc, r0
	mov	lr, pc
	b	SYM(objc2[CRATE_ID]::__macros::retain_semantics::copy_fail, 0)
...
LPC11_0:
	add	r0, pc, r0
	mov	lr, pc
	b	SYM(objc2[CRATE_ID]::__macros::retain_semantics::mutable_copy_fail, 0)
...
LPC14_0:
	...
	mov	r1, r4
	mov	lr, pc
	b	SYM(objc2[CRATE_ID]::__macros::retain_semantics::none_fail, 0)
