...
.LBB1_2:
	...
	mov	rdi, r14
	mov	rsi, rbx
	call	qword ptr [rip + SYM(objc2[CRATE_ID]::__macros::retain_semantics::new_fail, 0)@GOTPCREL]
.Lfunc_end1:
...
.LBB4_3:
	...
	mov	rdi, r14
	mov	rsi, rbx
	call	qword ptr [rip + SYM(objc2[CRATE_ID]::__macros::retain_semantics::init_fail, 0)@GOTPCREL]
.Lfunc_end4:
...
.LBB9_2:
	...
	call	qword ptr [rip + SYM(objc2[CRATE_ID]::__macros::retain_semantics::copy_fail, 0)@GOTPCREL]
.Lfunc_end9:
...
.LBB11_2:
	...
	call	qword ptr [rip + SYM(objc2[CRATE_ID]::__macros::retain_semantics::mutable_copy_fail, 0)@GOTPCREL]
.Lfunc_end11:
...
.LBB14_2:
	...
	mov	rdi, r14
	mov	rsi, rbx
	call	qword ptr [rip + SYM(objc2[CRATE_ID]::__macros::retain_semantics::none_fail, 0)@GOTPCREL]
.Lfunc_end14:
