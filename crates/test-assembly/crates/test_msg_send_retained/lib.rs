...
use objc2::__macro_helpers::{AllocFamily, CopyFamily, InitFamily, MsgSendRetained, MutableCopyFamily, NewFamily, NoneFamily};
use objc2::rc::{Allocated, Retained};
use objc2::runtime::{AnyClass, AnyObject, Sel};

#[no_mangle]
unsafe fn handle_new(cls: &AnyClass, sel: Sel) -> Option<Retained<AnyObject>> {
    NewFamily::send_message_retained(cls, sel, ())
}
...
unsafe fn handle_alloc(cls: &AnyClass, sel: Sel) -> Allocated<AnyObject> {
    AllocFamily::send_message_retained(cls, sel, ())
}

#[no_mangle]
unsafe fn handle_init(obj: Allocated<AnyObject>, sel: Sel) -> Option<Retained<AnyObject>> {
    InitFamily::send_message_retained(obj, sel, ())
}
...
unsafe fn handle_alloc_init(cls: &AnyClass, sel1: Sel, sel2: Sel) -> Option<Retained<AnyObject>> {
    let obj = AllocFamily::send_message_retained(cls, sel1, ());
    InitFamily::send_message_retained(obj, sel2, ())
}

#[no_mangle]
unsafe fn handle_alloc_release(cls: &AnyClass, sel: Sel) {
    let _obj: Allocated<AnyObject> = AllocFamily::send_message_retained(cls, sel, ());
}

#[no_mangle]
unsafe fn handle_alloc_init_release(cls: &AnyClass, sel1: Sel, sel2: Sel) {
    let obj = AllocFamily::send_message_retained(cls, sel1, ());
    let obj: Option<Retained<AnyObject>> = InitFamily::send_message_retained(obj, sel2, ());
    let _obj = obj.unwrap_unchecked();
}

#[no_mangle]
unsafe fn handle_copy(obj: &AnyObject, sel: Sel) -> Option<Retained<AnyObject>> {
    CopyFamily::send_message_retained(obj, sel, ())
}
...
unsafe fn handle_mutable_copy(obj: &AnyObject, sel: Sel) -> Option<Retained<AnyObject>> {
    MutableCopyFamily::send_message_retained(obj, sel, ())
}
...
unsafe fn handle_autoreleased(obj: &AnyObject, sel: Sel) -> Option<Retained<AnyObject>> {
    NoneFamily::send_message_retained(obj, sel, ())
}
...
unsafe fn handle_autoreleased_with_arg(
    ...
    NoneFamily::send_message_retained(obj, sel, (arg,))
}
...
unsafe fn handle_with_out_param(
    ...
    NoneFamily::send_message_retained(obj, sel, (param,))
}
