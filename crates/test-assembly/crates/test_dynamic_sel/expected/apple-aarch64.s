...
_fn3_get_common_twice:
	...
	add	x29, sp, #16
Lloh12:
	adrp	x19, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGE
Lloh13:
	ldr	x19, [x19, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGEOFF]
	ldr	x0, [x19]
	cbz	x0, LBB2_3
	ldr	x1, [x19]
	cbz	x1, LBB2_4
...
LBB2_3:
Lloh14:
	adrp	x0, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGE
Lloh15:
	ldr	x0, [x0, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGEOFF]
Lloh16:
...
LBB2_4:
Lloh18:
	adrp	x8, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGE
Lloh19:
	ldr	x8, [x8, SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)@GOTPAGEOFF]
Lloh20:
	adrp	x1, l_anon.[ID].1@PAGE
Lloh21:
	add	x1, x1, l_anon.[ID].1@PAGEOFF
