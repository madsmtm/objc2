...
LPC0_1:
	add	r1, pc, r1
	pop	{r7, lr}
	b	SYM(<objc2[CRATE_ID]::__macros::sel::CachedSel>::fetch, 0)
...
_fn3_get_common_twice:
	push	{r4, r7, lr}
	add	r7, sp, #4
	movw	r4, :lower16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_0+8))
	movt	r4, :upper16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_0+8))
LPC2_0:
	ldr	r4, [pc, r4]
	ldr	r0, [r4]
	cmp	r0, #0
...
LBB2_1:
	...
	popne	{r4, r7, pc}
LBB2_2:
	movw	r2, :lower16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_3+8))
	movt	r2, :upper16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_3+8))
LPC2_3:
	ldr	r2, [pc, r2]
...
LPC2_4:
	...
	pop	{r4, r7, pc}
LBB2_3:
	movw	r0, :lower16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_1+8))
	movt	r0, :upper16:(LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr-(LPC2_1+8))
LPC2_1:
	ldr	r0, [pc, r0]
...
.zerofill __DATA,__bss,__MergedGlobals,16,2
	...
	.p2align	2, 0x0
LSYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)$non_lazy_ptr:
	.indirect_symbol	SYM(objc2[CRATE_ID]::__macros::sel::alloc_sel::CACHED_SEL, 0)
	.long	0
