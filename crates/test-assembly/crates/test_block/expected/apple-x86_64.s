...
_fn1_stack_block_to_rc:
	...
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::stack_block_to_rc::{closure#0}>, 0)]
...
_fn2_rc_block:
	...
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::rc_block::{closure#0}>, 0)]
	mov	qword ptr [rbp - 16], rax
...
_fn3_rc_block_drop:
	...
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::rc_block_drop::{closure#0}>, 0)]
...
_fn4_create_and_use_stack_block:
	...
	mov	qword ptr [rbp - 32], rax
	mov	qword ptr [rbp - 24], 33554432
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::create_and_use_stack_block::{closure#0}>, 0)]
	mov	qword ptr [rbp - 16], rax
...
_fn5_create_and_use_stack_block_drop:
	...
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::create_and_use_stack_block_drop::{closure#0}>, 0)]
	mov	qword ptr [rbp - 32], rax
...
_fn6_create_and_use_rc_block:
	...
	lea	rax, [rip + SYM(block2[CRATE_ID]::traits::_::invoke::<i32, i32, test_block[CRATE_ID]::create_and_use_rc_block::{closure#0}>, 0)]
	mov	qword ptr [rbp - 24], rax
	lea	rax, [rip + L_anon.[ID].4]
	mov	qword ptr [rbp - 16], rax
	lea	rdi, [rbp - 40]
