...
LPC1_4:
	...
	mov	r3, #4
	bl	SYM(objc2::declare::ClassBuilder::add_ivar_inner_mono::GENERATED_ID, 0)
	movw	r10, :lower16:(l_anon.[ID].12-(LPC1_5+8))
	mov	r0, r4
	movt	r10, :upper16:(l_anon.[ID].12-(LPC1_5+8))
...
LPC1_6:
	ldr	r1, [pc, r1]
	movw	r11, :lower16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::class_type::ClassType>::class::{closure#0}::__objc2_dealloc, 0)-(LPC1_7+8))
	movt	r11, :upper16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::class_type::ClassType>::class::{closure#0}::__objc2_dealloc, 0)-(LPC1_7+8))
...
LPC1_10:
	...
	strd	r8, r9, [sp]
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
	movw	r1, :lower16:(L_OBJC_SELECTOR_REFERENCES_8dd788dbcc16b9bc-(LPC1_11+8))
	mov	r0, r4
	movt	r1, :upper16:(L_OBJC_SELECTOR_REFERENCES_8dd788dbcc16b9bc-(LPC1_11+8))
	mov	r2, r5
LPC1_11:
	ldr	r1, [pc, r1]
...
LPC1_12:
	...
	movw	r1, :lower16:(L_OBJC_SELECTOR_REFERENCES_450db9db0953dff5-(LPC1_13+8))
	mov	r0, r4
	movt	r1, :upper16:(L_OBJC_SELECTOR_REFERENCES_450db9db0953dff5-(LPC1_13+8))
	mov	r2, r5
LPC1_13:
	ldr	r1, [pc, r1]
...
LPC1_14:
	...
	strd	r10, r11, [sp]
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
	movw	r1, :lower16:(L_OBJC_SELECTOR_REFERENCES_783b35bc45c6e4a6-(LPC1_15+8))
	mov	r0, r4
	movt	r1, :upper16:(L_OBJC_SELECTOR_REFERENCES_783b35bc45c6e4a6-(LPC1_15+8))
LPC1_15:
	ldr	r1, [pc, r1]
...
LPC1_17:
	...
	mov	r2, r10
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
	movw	r1, :lower16:(L_OBJC_SELECTOR_REFERENCES_828e9fbc6d0b4498-(LPC1_18+8))
	mov	r0, r4
	movt	r1, :upper16:(L_OBJC_SELECTOR_REFERENCES_828e9fbc6d0b4498-(LPC1_18+8))
	mov	r2, r5
LPC1_18:
	ldr	r1, [pc, r1]
...
LPC1_19:
	...
	strd	r8, r9, [sp]
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
	movw	r1, :lower16:(L_OBJC_SELECTOR_REFERENCES_788cc14ba6a28eb8-(LPC1_20+8))
	mov	r0, r4
	movt	r1, :upper16:(L_OBJC_SELECTOR_REFERENCES_788cc14ba6a28eb8-(LPC1_20+8))
	mov	r2, r10
LPC1_20:
	ldr	r1, [pc, r1]
...
LPC1_22:
	...
	movw	r2, :lower16:(l_anon.[ID].17-(LPC1_23+8))
	mov	r3, #1
	movt	r2, :upper16:(l_anon.[ID].17-(LPC1_23+8))
...
LPC1_24:
	ldr	r1, [pc, r1]
	movw	r9, :lower16:(_copy_with_zone-(LPC1_25+8))
	movt	r9, :upper16:(_copy_with_zone-(LPC1_25+8))
LPC1_25:
	add	r9, pc, r9
	strd	r8, r9, [sp]
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
...
LBB1_4:
	...
	movw	r2, :lower16:(SYM(<&str as core[CRATE_ID]::fmt::Display>::fmt, 0)-(LPC1_29+8))
	movt	r2, :upper16:(SYM(<&str as core[CRATE_ID]::fmt::Display>::fmt, 0)-(LPC1_29+8))
	movw	r3, :lower16:(l_anon.[ID].21-(LPC1_30+8))
	movt	r3, :upper16:(l_anon.[ID].21-(LPC1_30+8))
	movw	r1, :lower16:(l_anon.[ID].10-(LPC1_31+8))
LPC1_28:
	add	r0, pc, r0
	movt	r1, :upper16:(l_anon.[ID].10-(LPC1_31+8))
	str	r0, [sp, #8]
	mov	r0, #1
	str	r0, [sp, #20]
	sub	r0, r7, #28
