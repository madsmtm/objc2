...
LPC1_25:
	ldr	r1, [pc, r1]
	movw	r2, :lower16:(l_anon.[ID].7-(LPC1_26+8))
	movt	r2, :upper16:(l_anon.[ID].7-(LPC1_26+8))
	strd	r8, r9, [sp]
LPC1_26:
	add	r2, pc, r2
	bl	SYM(objc2::declare::ClassBuilder::add_method_inner::GENERATED_ID, 0)
...
LBB1_4:
	...
	movw	r1, :lower16:(l_anon.[ID].15-(LPC1_31+8))
	movt	r1, :upper16:(l_anon.[ID].15-(LPC1_31+8))
