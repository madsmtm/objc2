...
LPC1_2:
	...
	mov	r0, #0
	strd	r0, r1, [sp]
	movw	r1, :lower16:(L_anon.[ID].12-(LPC1_3+8))
	movt	r1, :upper16:(L_anon.[ID].12-(LPC1_3+8))
LPC1_3:
	add	r1, pc, r1
	add	r4, sp, #8
	mov	r0, r4
...
LPC1_24:
	ldr	r1, [pc, r1]
	movw	r9, :lower16:(_copyWithZone-(LPC1_25+8))
	movt	r9, :upper16:(_copyWithZone-(LPC1_25+8))
LPC1_25:
	add	r9, pc, r9
	strd	r8, r9, [sp]
...
LBB3_3:
	...
	sub	r0, r7, #5
	str	r0, [r7, #-4]
	movw	r1, :lower16:(l_anon.[ID].16-(LPC3_1+8))
	movt	r1, :upper16:(l_anon.[ID].16-(LPC3_1+8))
LPC3_1:
	add	r1, pc, r1
	movw	r0, :lower16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::top_level_traits::ClassType>::class::REGISTER_CLASS, 0)-(LPC3_2+8))
	movt	r0, :upper16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::top_level_traits::ClassType>::class::REGISTER_CLASS, 0)-(LPC3_2+8))
LPC3_2:
	add	r0, pc, r0
	movw	r3, :lower16:(l_anon.[ID].0-(LPC3_3+8))
	movt	r3, :upper16:(l_anon.[ID].0-(LPC3_3+8))
LPC3_3:
	add	r3, pc, r3
	str	r1, [sp]
	sub	r2, r7, #4
...
LBB6_3:
	...
	sub	r0, r7, #5
	str	r0, [r7, #-4]
	movw	r1, :lower16:(l_anon.[ID].16-(LPC6_1+8))
	movt	r1, :upper16:(l_anon.[ID].16-(LPC6_1+8))
LPC6_1:
	add	r1, pc, r1
	movw	r0, :lower16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::top_level_traits::ClassType>::class::REGISTER_CLASS, 0)-(LPC6_2+8))
	movt	r0, :upper16:(SYM(<test_declare_class[CRATE_ID]::Custom as objc2[CRATE_ID]::top_level_traits::ClassType>::class::REGISTER_CLASS, 0)-(LPC6_2+8))
LPC6_2:
	add	r0, pc, r0
	movw	r3, :lower16:(l_anon.[ID].0-(LPC6_3+8))
	movt	r3, :upper16:(l_anon.[ID].0-(LPC6_3+8))
LPC6_3:
	add	r3, pc, r3
	str	r1, [sp]
	sub	r2, r7, #4
