...
.Lfunc_end2:
	.size	SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>, objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>)>, 0), .Lfunc_end2-SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>, objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>)>, 0)
	.section	.gcc_except_table.SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>, objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>)>, 0),"a",@progbits
	.p2align	2, 0x0
GCC_except_table2:
.Lexception0:
	.byte	255
...
.LBB3_1:
	...
	ret
.Lfunc_end3:
	.size	SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, true>,)>, 0), .Lfunc_end3-SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, true>,)>, 0)
...
.Ltmp25:
	mov	rdi, rbx
	mov	rsi, r14
	call	SYM(core[CRATE_ID]::ptr::drop_glue::<(core[CRATE_ID]::option::Option<objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>>,)>, 0)
.Ltmp26:
	mov	rdi, r15
	call	_Unwind_Resume@PLT
.LBB5_8:
...
.Ltmp41:
	mov	rdi, r14
	mov	rsi, rbx
	call	SYM(core[CRATE_ID]::ptr::drop_glue::<(core[CRATE_ID]::option::Option<objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, true>>,)>, 0)
.Ltmp42:
	mov	rdi, r15
	call	_Unwind_Resume@PLT
.LBB7_9:
...
.Ltmp49:
	lea	rdi, [rsp + 8]
	call	SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>, objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>)>, 0)
.Ltmp50:
.LBB8_8:
	mov	rdi, r15
	call	_Unwind_Resume@PLT
