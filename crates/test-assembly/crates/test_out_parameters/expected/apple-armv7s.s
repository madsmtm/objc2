...
Ltmp20:
	...
	str	r2, [sp, #16]
Ltmp21:
	bl	SYM(core[CRATE_ID]::ptr::drop_glue::<(core[CRATE_ID]::option::Option<objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>>,)>, 0)
Ltmp22:
	b	LBB5_13
LBB5_10:
	ldr	r0, [sp, #16]
...
Ltmp26:
	...
	str	r2, [sp, #16]
Ltmp27:
	bl	SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, true>,)>, 0)
Ltmp28:
	b	LBB6_10
LBB6_7:
	ldr	r0, [sp, #16]
...
Ltmp32:
	...
	str	r2, [sp, #16]
Ltmp33:
	bl	SYM(core[CRATE_ID]::ptr::drop_glue::<(core[CRATE_ID]::option::Option<objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, true>>,)>, 0)
Ltmp34:
	b	LBB7_14
LBB7_11:
	ldr	r0, [sp, #16]
...
Ltmp39:
	add	r0, sp, #20
	bl	SYM(core[CRATE_ID]::ptr::drop_glue::<(objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>, objc2[CRATE_ID]::__macros::writeback::RetainNewReleaseOldOnDrop<objc2[CRATE_ID]::runtime::nsobject::NSObject, false>)>, 0)
Ltmp40:
	b	LBB8_11
LBB8_7:
Ltmp46:
