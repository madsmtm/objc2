...
L0$pb:
	pop	eax
	mov	eax, dword ptr [eax + _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34-L0$pb]
	pop	ebp
	ret
...
L1$pb:
	pop	eax
	mov	eax, dword ptr [eax + _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a-L1$pb]
	pop	ebp
	ret
...
L2$pb:
	pop	eax
	mov	eax, dword ptr [eax + _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1-L2$pb]
	pop	ebp
	ret
...
L4$pb:
	...
	mov	edx, dword ptr [ecx + _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34-L4$pb]
	mov	esi, dword ptr [ecx + _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a-L4$pb]
	mov	edi, dword ptr [ecx + _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1-L4$pb]
	mov	ecx, dword ptr [ecx + _OBJC_CLASSLIST_REFERENCES_$_a92f01d3b55d29c5-L4$pb]
...
L5$pb:
	pop	ecx
	mov	eax, dword ptr [ebp + 8]
	mov	ecx, dword ptr [ecx + _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34-L5$pb]
