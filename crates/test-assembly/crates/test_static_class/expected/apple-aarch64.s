...
_fn1_get_class:
Lloh0:
	adrp	x8, _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34@PAGE
Lloh1:
	ldr	x0, [x8, _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34@PAGEOFF]
	ret
...
_fn1_get_same_class:
Lloh2:
	adrp	x8, _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a@PAGE
Lloh3:
	ldr	x0, [x8, _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a@PAGEOFF]
	ret
...
Lloh4:
	adrp	x8, _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1@PAGE
Lloh5:
	ldr	x0, [x8, _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1@PAGEOFF]
	ret
...
_fn5_use_fns:
Lloh6:
	adrp	x9, _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34@PAGE
Lloh7:
	ldr	x9, [x9, _OBJC_CLASSLIST_REFERENCES_$_1f36dafa1e0a7b34@PAGEOFF]
Lloh8:
	adrp	x10, _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a@PAGE
Lloh9:
	ldr	x10, [x10, _OBJC_CLASSLIST_REFERENCES_$_e1a6d3426ab3be5a@PAGEOFF]
Lloh10:
	adrp	x11, _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1@PAGE
Lloh11:
	ldr	x11, [x11, _OBJC_CLASSLIST_REFERENCES_$_5a6ce274a9f949e1@PAGEOFF]
Lloh12:
	adrp	x12, _OBJC_CLASSLIST_REFERENCES_$_a92f01d3b55d29c5@PAGE
Lloh13:
	ldr	x12, [x12, _OBJC_CLASSLIST_REFERENCES_$_a92f01d3b55d29c5@PAGEOFF]
	stp	x9, x10, [x8]
	stp	x11, x12, [x8, #16]
	ret
