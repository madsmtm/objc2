/// Check if APIs from a given operating system version is available.
///
/// Apple adds new APIs with new OS releases, and as developer, you often want
/// to use those to give your users the best behaviour, while still supporting
/// older OS versions that don't have those APIs (instead of crashing because
/// of an undefined selector).
///
