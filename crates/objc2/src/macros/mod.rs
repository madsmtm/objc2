...
/// `"unstable-core-darwin-objc"` feature, but that requires the nightly-only
/// `darwin_objc` language feature be enabled in every crate that uses this
/// macro, which can be achieved in `objc2-*` framework crates by enabling their
/// own `unstable-core-darwin-objc` features.
///
/// `"unstable-static-class"` and `"unstable-static-class-inlined"` take
/// precedence over `"unstable-core-darwin-objc"`.
///
///
/// # Examples
///
...
///
/// The `"unstable-core-darwin-objc"` feature solves this problem by implementing
...
/// nightly-only `darwin_objc` language feature be enabled in every crate
/// that uses this macro, which can be achieved in `objc2-*` framework crates
/// by enabling their own `unstable-core-darwin-objc` features.
///
