...
/// # Features
///
/// If the experimental `"unstable-static-class"` or
/// `"unstable-core-darwin-objc"` features are enabled, this will emit special
/// statics that will be replaced by dyld when the program starts up.
///
