...
extern_methods!(
    unsafe impl NSEntityDescription {
        ...
        pub unsafe fn entityForName_inManagedObjectContext(entityName: &NSString,context: &NSManagedObjectContext,) -> Option<Id<NSEntityDescription, Shared>>;

        #[method_id(@__retain_semantics Other insertNewObjectForEntityForName:inManagedObjectContext:)]
        pub unsafe fn insertNewObjectForEntityForName_inManagedObjectContext(entityName: &NSString,context: &NSManagedObjectContext,) -> Id<NSManagedObject, Shared>;
        ...
        #[method(setAbstract:)]
        pub unsafe fn setAbstract(&self, abstract: bool,);

        #[method_id(@__retain_semantics Other subentitiesByName)]
        pub unsafe fn subentitiesByName(&self, ) -> Id<NSDictionary<NSString,NSEntityDescription,>, Shared>;
        ...
        pub unsafe fn propertiesByName(&self, ) -> Id<NSDictionary<NSString,NSPropertyDescription,>, Shared>;
        ...
        pub unsafe fn attributesByName(&self, ) -> Id<NSDictionary<NSString,NSAttributeDescription,>, Shared>;

        #[method_id(@__retain_semantics Other relationshipsByName)]
        pub unsafe fn relationshipsByName(&self, ) -> Id<NSDictionary<NSString,NSRelationshipDescription,>, Shared>;

        #[method_id(@__retain_semantics Other relationshipsWithDestinationEntity:)]
        pub unsafe fn relationshipsWithDestinationEntity(&self, entity: &NSEntityDescription,) -> Id<NSArray<NSRelationshipDescription,>, Shared>;
        ...
        pub unsafe fn setUniquenessConstraints(&self, uniquenessConstraints: &NSArray<NSArray<Object,>,>,);
        ...
        pub unsafe fn setCoreSpotlightDisplayNameExpression(&self, coreSpotlightDisplayNameExpression: &NSExpression,);
