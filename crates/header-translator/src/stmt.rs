...
pub(crate) fn parse_class_generics(
    ...
    if let Some(generics_override) = &data.generics {
        generics_override
            .iter()
    ...
    pub fn parse(
        ...
        match entity.get_kind() {
            EntityKind::ObjCInterfaceDecl => {
                ...
                let generics = parse_class_generics(entity, context, data);
            ...
            EntityKind::ObjCCategoryDecl => {
                ...
                verify_objc_decl(entity, context);
                let generics = parse_class_generics(entity, context, cls_data);
