...
pub(crate) fn get_int_block_with(i: i32) -> RcBlock<(), i32> {
    unsafe {
...
pub(crate) fn get_add_block_with(i: i32) -> RcBlock<(i32,), i32> {
    unsafe {
...
pub(crate) fn invoke_int_block(block: &Block<(), i32>) -> i32 {
    let ptr = block as *const _;
    unsafe { objc2_test_utils::invoke_int_block(ptr as *mut _) }
}

pub(crate) fn invoke_add_block(block: &Block<(i32,), i32>, a: i32) -> i32 {
    let ptr = block as *const _;
