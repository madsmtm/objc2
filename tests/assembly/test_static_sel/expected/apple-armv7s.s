...
_get_sel:
	push	{r7, lr}
	mov	r7, sp
	bl	__ZN15test_static_sel7get_sel22objc_static_workaround17h648950fc43b2702aE
	pop	{r7, pc}
...
_get_same_sel:
	push	{r7, lr}
	mov	r7, sp
	bl	__ZN15test_static_sel12get_same_sel22objc_static_workaround17hec9e77b171bc9113E
	pop	{r7, pc}
...
_get_common_twice:
	push	{r4, r7, lr}
	add	r7, sp, #4
	bl	__ZN15test_static_sel16get_common_twice22objc_static_workaround17h3db0895ffade7f9dE
	mov	r4, r0
	bl	__ZN15test_static_sel16get_common_twice22objc_static_workaround17h71fa1210656cf2c8E
	mov	r1, r0
	mov	r0, r4
	pop	{r4, r7, pc}
...
_unused_sel:
	push	{r7, lr}
	mov	r7, sp
	bl	__ZN15test_static_sel10unused_sel22objc_static_workaround17hf7c0f8731f9903e4E
	pop	{r7, pc}
...
LBB7_2:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel7get_sel22objc_static_workaround17h648950fc43b2702aE:
...
LPC8_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel12get_same_sel22objc_static_workaround17hec9e77b171bc9113E:
...
LPC9_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel16get_common_twice22objc_static_workaround17h3db0895ffade7f9dE:
...
LPC10_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel16get_common_twice22objc_static_workaround17h71fa1210656cf2c8E:
...
LPC11_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel17get_different_sel22objc_static_workaround17hfae2030587df69c1E:
...
LPC12_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel10unused_sel22objc_static_workaround17hf7c0f8731f9903e4E:
...
LPC14_0:
	...
	.p2align	2
	.code	32
__ZN15test_static_sel11use_in_loop22objc_static_workaround17hbed100d6afc97340E:
